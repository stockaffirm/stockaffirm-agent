...
TOOLS = [
    ...
    Tool(
        ...
        description=(
            ...
            "The output of this tool is a json that maps the field to a list of alphavantage functions or tables that can be used to call the fetch_alpha_data tool"
            "The output received should be interpreted. Field names will not be exact as requested but use your financial acumen to match the fields you are looking for"
